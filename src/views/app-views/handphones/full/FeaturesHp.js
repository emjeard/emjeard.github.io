            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_musik_status">---</Option>
                </Select>
              </div>
            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_radio_status">---</Option>
                </Select>
              </div>
              <div style={{ width: "100%", margin: "30px 0px 0px 20px" }}>
                <Input.Group compact>
            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_tvanalog">---</Option>
                </Select>
              </div>
              <div style={{ width: "100%", margin: "30px 0px 0px 20px" }}>
                <Input.Group compact>
            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_gps_status">---</Option>
                </Select>
              </div>
              <div style={{ width: "100%", margin: "30px 0px 0px 20px" }}>
                <Input.Group compact>
            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_browser_status">---</Option>
                </Select>
              </div>
              <div style={{ width: "100%", margin: "30px 0px 0px 20px" }}>
                <Input.Group compact>
            ...
            <div className="lay-subsegment" style={{ display: "flex" }}>
              <div>
                ...
                >
                  ...
                  <Option value="0--fit_wresistant_status">---</Option>
                </Select>
              </div>
              <div style={{ width: "100%", margin: "30px 0px 0px 20px" }}>
                <Input.Group compact>
