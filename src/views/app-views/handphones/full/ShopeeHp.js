...
const ShopeeHp = () => {
  ...
  return (
    <div>
      <div id="shopee" className="lay-segment affix-shopee">
        Shopee
      </div>
      <div
        ...
        <div className="lay-subsegment">
          <div style={{ padding: "0px 10px", margin: "0px 0px 0px 0px" }}>
            <div style={{ display: "flex" }}>
              ...
              <Input
                name="shopee_hp"
                defaultValue={store.getState().gen_hp_data.data.shopee_hp}
          ...
          <div style={{ padding: "0px 10px", margin: "10px 0px 0px 0px" }}>
            <div style={{ display: "flex" }}>
              ...
              <Input
                name="shopee_acc"
                defaultValue={store.getState().gen_hp_data.data.shopee_acc}
                onChange={onChangeInputGeneral}
                placeholder="http"
                style={{ width: "100%" }}
                allowClear
