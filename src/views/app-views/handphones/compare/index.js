...
import { getListCompareHp } from "api/ApiData";
...
const CompareHandphoneApp = () => {
  ...
  const retrieveDatahp = (page, many, filter) => {
    ...
    getListCompareHp(page, many, filter)
      .then((response) => {
      ...
      <Card>
        ...
        <Sticky enabled={true} top={70} innerZ={1}>
          <div style={{ display: "flex", backgroundColor: "#F44336" }}>
            ...
            <div
              className="rss-head-text lay-hp-name"
            ...
            <div className="rss-head-text lay-hp-act-pict">Edit</div>
          </div>
        </Sticky>
        ...
        {dataNews &&
          dataNews.map((items, index) => (
            ...
            >
              <ListHandphone
                id={items.id}
                id_hp_1={items.id_hp1}
                id_hp_2={items.id_hp2}
                nama_hp={items.nama_hp_1}
                nama_hp2={items.nama_hp_2}
              />
            </div>
          ))}
        <div
...
export default CompareHandphoneApp;
