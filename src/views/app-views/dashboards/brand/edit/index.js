...
import { getListCountry, getDetailBrand, putUpdateBrand } from "api/ApiData";
  ...
  const retrieveData = () => {
    ...
    getDetailBrand(brandId)
      .then((response) => {
        ...
        setBrandName(dataPage.merk);
        setMetaTitle(dataPage.meta_title);
        setMetaDesc(dataPage.meta_desc);
        setBrandState({
          ...brandState,
          description: dataPage.desc_company,
          website: dataPage.url,
          facebook: dataPage.fb,
          facebook_id: dataPage.fb_id,
          image: dataPage.logo,
          category: dataPage.grup_kategori,
          country: dataPage.id_negara,
          twitter: dataPage.tw,
          address: dataPage.alamat,
          email: dataPage.em,
          phone: dataPage.c_center,
          youtube: dataPage.ytube,
          instagram: dataPage.instagram,
        });
        setDefDataTagCountry(dataPage.id_negara);
        store.dispatch(
          dataPage.desc_html !== ""
            ? INPUT_1_ACT(dataPage.desc_html)
            : INPUT_1_ACT(dataPage.desc_company)
        );
    ...
    <div>
      <Card>
        ...
        <div style={{ margin: "15px 0px" }}>
          ...
          <Drag
            image={
              brandState.image.includes("ik.imagekit.io")
                ? brandState.image
                : "https://static.inponsel.com/images/brands/" +
                  brandState.image
            }
            folder="brands"
            filename={brandName}
