...
export const APP_NAME = 'InPonsel';
...
const TemplateSetting = () => {
	return (
		<div>
			...
			<p>InPonsel comes with a variety of different theme & layout, you can try them from quick view panel in our demo and copy the config to your project.</p>
			<div className="mt-4">
